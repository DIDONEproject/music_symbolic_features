...
# python -m symbolic_features.effectiveness classification --featureset=$1 --dataset=$2 --extension=$3 --keep_first_10_pc=$4 2>&1 | tee $5
    ...
    for dataset in $datasets; do
      for extension in $extensions; do
        ...
        echo "Experiment started: $pca $featureset $dataset $extension" | tee $1
  			python -m symbolic_features.effectiveness classification --featureset=$featureset --dataset=$dataset --extension=$extension --keep_first_10_pc=$pca 2>&1 | tee $1
